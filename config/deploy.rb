...
set :user, 'apps'
set :domain, '52.193.73.226'
set :deploy_to, '/home/apps/new_taipei_activities'
set :repository, 'git@github.com:alanyeh20001/new_taipei_activities.git'
set :branch, 'master'
